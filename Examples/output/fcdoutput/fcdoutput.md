...
# 1. Change directory
cd /home/miguel/6.Projects/Thesis/Examples/output/fcdoutput
...
# 4. Second Example: Run simulation (only write attribute "x,y" instead of default attributes)  (20% agents will be tracked) and parquet output
sumo-gui -n input.net.xml --fcd-output fcd-export.parquet --device.fcd.probability 0.2 --seed 42 --fcd-output.attributes x,y -r output_shortest_path.routes.xml
