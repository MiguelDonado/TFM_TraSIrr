### Preventivos vs Reactivos
- **Preventivos**: 
  - Utilizan datos historicos (DUE y en general todos los procesos iterativos)
  - Aseguras que sean realistas y luego tocas los parametros para acercarte a la realidad
- **Reactivos**:
