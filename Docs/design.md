...
- The minimum trip distance is set proportional to the median edge length of the network, providing a robust measure that avoids sensitivity to extreme values.
  1 edge → too short
  2 edges → still short
